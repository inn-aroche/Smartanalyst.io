...
function createApp() {
  ...
  // Workspace branding (white-label — cahier §3 Lot 4)
  ...
  // Widgets épinglés (cahier 22b §3.4 — Lot V2.3)
  app.use('/api/v1/pinned-widgets', require('./routes/pinned-widgets.routes'))
