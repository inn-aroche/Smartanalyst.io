...
const en = {
  ...
  'onboarding.s3.hint': 'Your profile',
  'onboarding.s3.title': 'A few questions so I can help you better',
  'onboarding.s3.body': 'This helps me tailor insights, actions, and priorities to your reality.',
  'onboarding.s3.businessModel': 'Business model',
  'onboarding.s3.businessModel.b2b': 'B2B',
  'onboarding.s3.businessModel.b2c': 'B2C',
  'onboarding.s3.businessModel.b2b2c': 'B2B2C',
  'onboarding.s3.businessModel.marketplace': 'Marketplace',
  'onboarding.s3.businessModel.other': 'Other',
  'onboarding.s3.maturityLevel': 'Your marketing maturity',
  'onboarding.s3.maturityLevel.beginner': 'Getting started',
  'onboarding.s3.maturityLevel.beginner.desc': 'Few tools, mostly manual tracking',
  'onboarding.s3.maturityLevel.intermediate': 'Growing',
  'onboarding.s3.maturityLevel.intermediate.desc': 'GA4, ads running, some automations',
  'onboarding.s3.maturityLevel.advanced': 'Advanced',
  'onboarding.s3.maturityLevel.advanced.desc': 'Multi-channel, attribution, CRM synced',
  'onboarding.s3.primaryGoal': 'What matters most right now?',
  'onboarding.s3.primaryGoal.grow_revenue': 'Grow revenue',
  'onboarding.s3.primaryGoal.reduce_cac': 'Reduce acquisition cost',
  'onboarding.s3.primaryGoal.improve_retention': 'Improve retention',
  'onboarding.s3.primaryGoal.optimize_campaigns': 'Optimize campaigns',
  'onboarding.s3.primaryGoal.understand_customers': 'Understand customers',
  'onboarding.s3.currentStack': 'Tools you use today',
  'onboarding.s3.currentStack.placeholder': 'Select the tools you currently use',
  'onboarding.s3.cta': 'Continue',
  'onboarding.s3.saving': 'Saving…',
  'onboarding.s4.hint': '1-click connection',
  'onboarding.s4.title': 'Connect your first source',
  'onboarding.s4.body': "For your activity, I'd start with",
  'onboarding.s4.desc': 'Sales, products, customers — read-only',
  'onboarding.s4.recommended': 'Recommended',
  'onboarding.s4.connect': 'Connect Shopify',
  'onboarding.s4.later': "I'll connect later",
  'onboarding.s4.fallback':
    "I couldn't read the site automatically — manual mode. Pick the source you check the most and we'll go from there.",
  'onboarding.s5.title': 'Pulling your last 30 days…',
  'onboarding.s5.body': 'Computing your health score and first signals. Usually under a minute.',
  'onboarding.s5.check1': 'Connection ready',
  'onboarding.s5.check2': 'Health score computed',
  'onboarding.s5.check3': 'First signals ready',
  'onboarding.s5.slow': "Taking a bit longer than usual — we're still on it.",
  'onboarding.s5.error': 'Something slowed us down. Opening your space anyway.',
  'onboarding.s5.live': 'Loading your first analysis',
  'onboarding.s6.done': 'Analysis complete',
  'onboarding.s6.title': "Here's what I already spotted.",
  'onboarding.s6.body': 'Your starting health score and the first signals on your real data.',
  'onboarding.s6.cardTitle': 'Good start.',
  'onboarding.s6.cardTitleNamed': 'Good start, {{name}}.',
  'onboarding.s6.cardBody':
    "Your acquisition is solid. Your first lever: conversion — we'll work on it together.",
  'onboarding.s6.cardBodyNoData':
    "I'll have more to say as soon as your data finishes flowing in. In the meantime, here's your fresh space.",
  'onboarding.s6.errorNoWorkspace':
    "Your account isn't fully set up yet. Refresh the page, or contact support if this persists.",
  'onboarding.s6.cta': 'Enter my space',
...
const fr: Record<keyof typeof en, string> = {
  ...
  // Step 3 — quiz maturité
  'onboarding.s3.hint': 'Ton profil',
  'onboarding.s3.title': "Quelques questions pour mieux t'aider",
  'onboarding.s3.body': "Ça me permet d'adapter les insights, actions et priorités à ta réalité.",
  'onboarding.s3.businessModel': 'Modèle commercial',
  'onboarding.s3.businessModel.b2b': 'B2B',
  'onboarding.s3.businessModel.b2c': 'B2C',
  'onboarding.s3.businessModel.b2b2c': 'B2B2C',
  'onboarding.s3.businessModel.marketplace': 'Marketplace',
  'onboarding.s3.businessModel.other': 'Autre',
  'onboarding.s3.maturityLevel': 'Ta maturité marketing',
  'onboarding.s3.maturityLevel.beginner': 'Je débute',
  'onboarding.s3.maturityLevel.beginner.desc': "Peu d'outils, suivi principalement manuel",
  'onboarding.s3.maturityLevel.intermediate': 'En croissance',
  'onboarding.s3.maturityLevel.intermediate.desc': 'GA4, pubs en cours, quelques automatisations',
  'onboarding.s3.maturityLevel.advanced': 'Avancé',
  'onboarding.s3.maturityLevel.advanced.desc': 'Multi-canal, attribution, CRM connecté',
  'onboarding.s3.primaryGoal': 'Ce qui compte le plus maintenant ?',
  'onboarding.s3.primaryGoal.grow_revenue': "Augmenter le chiffre d'affaires",
  'onboarding.s3.primaryGoal.reduce_cac': "Réduire le coût d'acquisition",
  'onboarding.s3.primaryGoal.improve_retention': 'Améliorer la rétention',
  'onboarding.s3.primaryGoal.optimize_campaigns': 'Optimiser les campagnes',
  'onboarding.s3.primaryGoal.understand_customers': 'Comprendre mes clients',
  'onboarding.s3.currentStack': "Outils que tu utilises aujourd'hui",
  'onboarding.s3.currentStack.placeholder': 'Sélectionne les outils que tu utilises actuellement',
  'onboarding.s3.cta': 'Continuer',
  'onboarding.s3.saving': 'Sauvegarde…',
  'onboarding.s4.hint': 'Connexion en 1 clic',
  'onboarding.s4.title': 'Connecte ta première source',
  'onboarding.s4.body': 'Pour ton activité, je te recommande de commencer par',
  'onboarding.s4.desc': 'Ventes, produits, clients — lecture seule',
  'onboarding.s4.recommended': 'Recommandé',
  'onboarding.s4.connect': 'Connecter Shopify',
  'onboarding.s4.later': 'Je connecterai plus tard',
  'onboarding.s4.fallback':
    "Je n'ai pas pu lire le site automatiquement — mode manuel. Choisis la source que tu regardes le plus, on partira de là.",
  'onboarding.s5.title': 'Je récupère tes 30 derniers jours…',
  'onboarding.s5.body':
    'Calcul de ton score de santé et des premiers signaux. Généralement moins d’une minute.',
  'onboarding.s5.check1': 'Connexion en place',
  'onboarding.s5.check2': 'Score de santé calculé',
  'onboarding.s5.check3': 'Premiers signaux extraits',
  'onboarding.s5.slow': "C'est un peu plus long que d'habitude — on continue.",
  'onboarding.s5.error': 'Petit ralenti, on ouvre quand même ton espace.',
  'onboarding.s5.live': 'Chargement de ta première analyse',
  'onboarding.s6.done': 'Analyse terminée',
  'onboarding.s6.title': "Voici ce que j'ai déjà repéré.",
  'onboarding.s6.body':
    'Ton score de santé de départ et les premiers signaux sur tes vraies données.',
  'onboarding.s6.cardTitle': 'Bon départ.',
  'onboarding.s6.cardTitleNamed': 'Bon départ, {{name}}.',
  'onboarding.s6.cardBody':
  ...
  'onboarding.s6.cta': 'Entrer dans mon espace',
