...
const en = {
  ...
  'audit.subtitle':
    'SEO + GEO (AI search readiness) + Performance (Core Web Vitals via Google PageSpeed). 25+ checks. AI scoring coming soon.',
...
const fr: Record<keyof typeof en, string> = {
  ...
  'audit.subtitle':
    'SEO + GEO (visibilité dans les moteurs IA) + Performance (Core Web Vitals via Google PageSpeed). 25+ checks. Scoring IA bientôt.',
