...
export const PRODUCT_FEATURES = [
  {
    ...
    en: {
      ...
      hero: "Ask your data the same way you'd ask a teammate. Structured answers come back with the numbers, the time window, the causes, and what to do next.",
      ...
      how: [
        {
          title: '1. Plain language input',
          body: 'You type in English or French. No SQL, no metric picker. "Why did CVR drop last week?" is enough.',
        },
        {
          title: '2. Query planning',
          body: 'The AI maps your question to the canonical metrics layer, picks the right sources, builds the SQL/API calls, and runs them with the right window comparison.',
        },
        {
          title: '3. Structured answer',
          body: 'Result: a TL;DR + the underlying numbers + 2-3 contributing factors + recommended actions. Every number is sourced, you can click to see the raw connector data.',
        },
        {
          title: '4. Follow-ups',
          body: 'Each answer keeps context, so you can refine without re-explaining. "Same thing but for last 30 days?" works.',
        },
      ],
      ...
      under_hood:
        'Multi-model AI stack (Gemini 2.5 Flash for fast structured answers, Claude for deep multi-source analysis when needed). Every answer is grounded in your live connector data via the canonical metrics layer through function calling, never hallucinated. A per-workspace token budget keeps costs predictable. Your data never leaves the European hosting region.',
    ...
    fr: {
      ...
      hero: 'Parle à tes données comme tu parlerais à un collègue. Tu reçois une réponse structurée avec les chiffres, la période, les causes, et les actions recommandées.',
      ...
      how: [
        {
          title: '1. Question en langage naturel',
          body: 'Tape en français ou en anglais. Pas de SQL, pas de sélecteur de métriques. « Pourquoi le taux de conversion a baissé la semaine dernière ? » suffit.',
        },
        {
          title: '2. Planification de la requête',
          body: 'L’IA mappe ta question sur la couche de métriques canoniques, choisit les bonnes sources, construit les appels SQL/API et lance la bonne comparaison temporelle.',
        },
        {
          title: '3. Réponse structurée',
          body: 'Résultat : un TL;DR + les chiffres sous-jacents + 2 à 3 facteurs contributifs + actions recommandées. Chaque chiffre est sourcé, un clic pour voir la donnée brute du connecteur.',
        },
        {
          title: '4. Suivis',
          body: 'Chaque réponse garde le contexte. Tu raffines sans tout ré-expliquer. « Pareil mais sur 30 jours ? » fonctionne.',
        },
      ],
      ...
      under_hood:
        'Stack IA multi-modèles (Gemini 2.5 Flash pour les réponses structurées rapides, Claude pour les analyses multi-sources profondes quand c’est nécessaire). Chaque réponse est ancrée dans tes données live via la couche de métriques canoniques, par function calling, jamais hallucinée. Un budget de tokens par workspace garde les coûts prévisibles. Tes données ne quittent jamais l’hébergement européen.',
  ...
  },
  {
    ...
    en: {
      ...
      hero: 'Connect GA4, Meta Ads, Google Ads, Stripe and Search Console in one click each. We pull the last 90 days on day one, then keep syncing. Tokens encrypted via Supabase Vault, Row-Level Security on every row.',
      ...
      how: [
        {
          title: '1. One-click OAuth',
          body: "You authorize SmartAnalyst on the source's screen. Refresh tokens are stored encrypted at rest, never logged.",
        },
        {
          title: '2. Initial backfill',
          body: 'We pull the last 90 days of metrics on connection. No manual export.',
        },
        {
          title: '3. Incremental sync',
          body: 'Hourly or daily depending on the source. We track sync status per connector, green/orange/red so you always know if a number is fresh.',
        },
        {
          title: '4. Canonical mapping',
          body: 'Raw API responses are mapped to our canonical metrics layer (see canonical-metrics). Sources never bleed their naming into your dashboard.',
        },
      ],
      h2_examples: 'Roadmap',
      examples: [
    ...
    fr: {
      ...
      hero: 'Connecte GA4, Meta Ads, Google Ads, Stripe et Search Console en un clic chacun. On synchronise les 90 derniers jours dès la connexion, puis en continu. Tokens chiffrés via Supabase Vault, Row-Level Security partout.',
      ...
      how: [
        {
          title: '1. OAuth en 1 clic',
          body: 'Tu autorises SmartAnalyst sur l’écran de la source. Les refresh tokens sont stockés chiffrés au repos, jamais loggés.',
        },
        {
          title: '2. Backfill initial',
          body: 'On synchronise les 90 derniers jours dès la connexion. Pas d’export manuel.',
        },
        {
          title: '3. Sync incrémental',
          body: 'Horaire ou journalier selon la source. On suit le statut par connecteur, vert/orange/rouge pour que tu saches si un chiffre est frais.',
        },
        {
          title: '4. Mapping canonique',
          body: 'Les réponses API brutes sont mappées sur notre couche de métriques canoniques. Les sources ne polluent pas ton dashboard avec leur vocabulaire.',
        },
      ],
      h2_examples: 'Roadmap',
      examples: [
  ...
  },
  {
    ...
    en: {
      ...
      hero: 'GA4 says "sessions". Meta says "reach". Google Ads says "impressions". Stripe says "successful_payments". A naive AI gets lost or compares apples to oranges. Our canonical layer normalizes everything into one shared metric vocabulary.',
      ...
      how: [
        {
          title: '1. Source mapping',
          body: 'Every metric in every connector has an explicit mapping to a canonical key (e.g. ga4.sessions → sessions_all, meta_ads.impressions → impressions_paid_social).',
        },
        {
          title: '2. Type-safe transforms',
          body: 'Currency conversions, timezone normalization (everything in your workspace timezone), and date alignment happen here. No timezone-shift surprises.',
        },
        {
          title: '3. Confidence score',
          body: 'Each canonical metric carries a 0-100 confidence score. Bad data from a flaky API drops the score, and the AI flags it instead of pretending the number is solid.',
        },
        {
          title: '4. Audit trail',
          body: 'Every canonical metric value links back to its source row(s). One click to see the GA4 / Meta / Stripe response that produced it.',
        },
      ],
    ...
    fr: {
      ...
      hero: 'GA4 dit « sessions ». Meta dit « reach ». Google Ads dit « impressions ». Stripe parle de « successful_payments ». Une IA naïve s’y perd ou compare des choux et des carottes. Notre couche canonique normalise tout dans un seul vocabulaire métrique partagé.',
      ...
      how: [
        {
          title: '1. Mapping par source',
          body: 'Chaque métrique de chaque connecteur a un mapping explicite vers une clé canonique (ex : ga4.sessions → sessions_all, meta_ads.impressions → impressions_paid_social).',
        },
        {
          title: '2. Transformations type-safe',
          body: 'Conversions de devises, normalisation des fuseaux horaires (tout dans le timezone de ton workspace), alignement des dates. Pas de surprises de décalage.',
        },
        {
          title: '3. Score de confiance',
          body: 'Chaque métrique canonique porte un score 0-100. Des données médiocres d’une API capricieuse baissent le score, et l’IA le signale au lieu de prétendre que le chiffre est solide.',
        },
        {
          title: '4. Traçabilité',
          body: 'Chaque valeur canonique pointe vers les lignes sources qui l’ont produite. Un clic pour voir la réponse GA4 / Meta / Stripe brute.',
        },
      ],
  ...
  },
  {
    ...
    icon: '◐',
    en: {
      kicker: 'Morning brief & Watch',
      title: 'Know before it hurts.',
      tagline: 'A daily brief plus alerts you write in plain language.',
      hero: 'Two complementary surfaces. Your morning brief lands every weekday at 8am, anomalies the AI spotted, opportunities worth pursuing, risks to watch. Watch lets you write custom alerts in plain language (« ping me when ROAS drops below 2 ») and trust them to fire only when the condition really hits.',
      ...
      how: [
        {
          title: 'Anomalies',
          body: 'Statistical outliers: a metric drifted >2σ from its 30-day baseline, or a conversion funnel step dropped sharply. With the likely cause if we can identify one.',
        },
        {
          title: 'Opportunities',
          body: "Campaigns hitting good ROAS that could absorb more budget. Search queries you're winning organically, worth bidding on. Audiences performing better than expected.",
        },
        {
          title: 'Risks',
          body: 'Ad fatigue signals (declining CTR with stable creative age). Sudden tracking gaps. CPC drift on key terms. Subscription churn spikes.',
        },
        {
          title: 'Always with context',
          body: 'Every item links back to the chat, click to dig in with follow-up questions. No item ships without supporting evidence.',
        },
      ],
    ...
    fr: {
      kicker: 'Point du jour & Veille',
      title: 'Sache avant que ça fasse mal.',
      tagline: 'Un point du jour quotidien + des veilles que tu écris en langage naturel.',
      hero: 'Deux surfaces complémentaires. Ton point du jour arrive chaque matin de semaine à 8h : anomalies détectées par l’IA, opportunités à saisir, risques à surveiller. La Veille te laisse écrire des alertes custom en langage naturel (« préviens-moi quand mon ROAS descend sous 2 ») et leur fait confiance pour ne se déclencher que quand la condition est vraiment atteinte.',
      ...
      how: [
        {
          title: 'Anomalies',
          body: 'Outliers statistiques : une métrique a dévié de >2σ par rapport à sa baseline 30 jours, ou une étape de funnel a chuté brutalement. Avec la cause probable si on peut l’identifier.',
        },
        {
          title: 'Opportunités',
          body: 'Campagnes au ROAS solide qui pourraient absorber plus de budget. Requêtes search où tu performes en organique, à bidder en paid. Audiences qui performent au-dessus des attentes.',
        },
        {
          title: 'Risques',
          body: 'Signes de fatigue créa (CTR en baisse avec créa du même âge). Pertes de tracking soudaines. Dérive de CPC sur des termes clés. Pics de churn.',
        },
        {
          title: 'Toujours avec contexte',
          body: 'Chaque item renvoie au chat, un clic pour creuser avec des questions de suivi. Aucun item sans preuves.',
        },
      ],
  ...
  },
  {
    ...
    en: {
      ...
      hero: "Every month on the 1st, a PDF lands in your client's inbox, executive summary, key metrics, charts, recommendations. Built from live data, signed off by the AI, branded with your logo.",
      ...
      how: [
        {
          ...
          body: '3 paragraphs at the top: what happened, what worked, what to fix. Written by the AI in your voice (custom prompt per workspace if needed).',
        },
        {
          title: '2. KPI grid',
          body: 'The 6-8 metrics that matter for this client, with delta vs previous period. Configurable per workspace.',
        },
        {
          title: '3. Channel sections',
          body: 'One section per active connector. Paid social, paid search, SEO, revenue, only the ones your client actually uses.',
        },
        {
          title: '4. Recommendations',
          body: 'The same items as the weekly proactive insights, rolled up for the month with explicit next-step actions.',
        },
      ],
    ...
    fr: {
      ...
      hero: 'Chaque mois le 1ᵉʳ, un PDF atterrit dans la boîte de ton client, résumé exécutif, métriques clés, graphiques, recommandations. Construit sur les données live, signé par l’IA, brandé à ton logo.',
      ...
      how: [
        {
          ...
          body: '3 paragraphes en haut : ce qui s’est passé, ce qui a marché, ce qu’il faut corriger. Rédigé par l’IA dans ton ton (prompt custom par workspace si besoin).',
        },
        {
          title: '2. Grille de KPIs',
          body: 'Les 6-8 métriques qui comptent pour ce client, avec delta vs période précédente. Configurable par workspace.',
        },
        {
          title: '3. Sections par canal',
          body: 'Une section par connecteur actif. Paid social, paid search, SEO, revenu, seulement ceux que ton client utilise vraiment.',
        },
        {
          title: '4. Recommandations',
          body: 'Les mêmes items que les insights proactifs hebdo, agrégés sur le mois avec actions explicites.',
        },
      ],
  ...
  },
  {
    ...
    en: {
      ...
      hero: 'Designed for agencies and freelancers managing portfolios. Each workspace is an isolated tenant, own connectors, own metrics, own reports, own brand. Switch with one click from the top-left dropdown.',
      ...
      how: [
        {
          ...
          body: 'Each client lives in its own workspace. Their data never bleeds into another workspace, enforced at the database level via Row-Level Security.',
        },
        {
          title: 'Shared team',
          body: 'Your team members get access to the workspaces you assign. Roles: admin, editor, viewer. Add a junior on one client, full access on another.',
        },
        {
          title: 'Per-workspace brand',
          body: 'Each workspace can have its own logo + colors. Reports and email templates pick the right brand automatically.',
        },
        {
          title: 'Top-level dashboard',
          body: 'Cross-workspace view at the org level, your overall MRR across all clients, total ad spend you manage, alerts across the portfolio.',
        },
      ],
    ...
    fr: {
      ...
      hero: 'Pensé pour les agences et freelances qui gèrent un portefeuille. Chaque workspace est un tenant isolé, propres connecteurs, propres métriques, propres rapports, propre marque. Bascule en un clic depuis le menu en haut à gauche.',
      ...
      how: [
        {
          title: 'Tenants isolés',
          body: 'Chaque client vit dans son propre workspace. Sa donnée ne fuit jamais vers un autre workspace, appliqué au niveau base via Row-Level Security.',
        },
        {
          title: 'Équipe partagée',
          body: 'Tes membres d’équipe ont accès aux workspaces que tu leur assignes. Rôles : admin, editor, viewer. Ajoute un junior sur 1 client, full access sur un autre.',
        },
        {
          title: 'Marque par workspace',
          body: 'Chaque workspace a son logo + ses couleurs. Les rapports et templates email piochent la bonne marque automatiquement.',
        },
        {
          title: 'Dashboard top-level',
          body: 'Vue cross-workspace au niveau de ton organisation, MRR total tous clients, dépense pub totale gérée, alertes sur le portefeuille.',
        },
      ],
  ...
  },
  {
    ...
    en: {
      ...
      hero: 'Reports, emails, the client-facing dashboard, all in your colors and your logo. On the Agency plan, even the URL can be yours (custom domain on the roadmap).',
      ...
      how: [
        {
          title: 'Logo + colors (Pro)',
          body: 'Upload your logo, set primary + accent colors. Reports, the proactive-insights email, and the client-facing dashboard pick those up automatically.',
        },
        {
          title: 'Email sender (Pro)',
          body: 'Reports and alerts can be sent from a custom address (e.g. reports@youragency.com). DMARC/SPF setup is one DNS record.',
        },
        {
          title: 'Full white-label (Agency)',
          body: 'All visible mentions of SmartAnalyst removed. Footers cleaned. Login screens for your clients use your branding.',
        },
        {
          title: 'Custom domain (roadmap, Agency)',
          body: 'Serve the client portal at app.youragency.com. Pending TLS automation work.',
        },
      ],
      h2_examples: 'Levels',
      examples: [
    ...
    fr: {
      ...
      hero: 'Rapports, emails, dashboard client, tout dans tes couleurs et ton logo. Sur le plan Agence, même l’URL peut être à toi (domaine custom dans la roadmap).',
      ...
      how: [
        {
          title: 'Logo + couleurs (Pro)',
          body: 'Upload ton logo, paramètre couleur principale + accent. Rapports, email d’insights proactifs et dashboard client les reprennent automatiquement.',
        },
        {
          title: 'Email expéditeur (Pro)',
          body: 'Rapports et alertes peuvent partir d’une adresse custom (ex. rapports@tonagence.com). Setup DMARC/SPF = un enregistrement DNS.',
        },
        {
          title: 'Marque blanche complète (Agence)',
          body: 'Toutes les mentions visibles de SmartAnalyst supprimées. Footers nettoyés. Écrans de login pour tes clients à ta marque.',
        },
        {
          title: 'Domaine custom (roadmap, Agence)',
          body: 'Servir le portail client à app.tonagence.com. En attente de l’automatisation TLS.',
        },
      ],
      h2_examples: 'Niveaux',
      examples: [
...
export const PRODUCT_FEATURES_BY_SLUG = Object.fromEntries(PRODUCT_FEATURES.map((f) => [f.slug, f]))
